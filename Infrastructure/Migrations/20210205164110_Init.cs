        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultCategory = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "text", nullable: false),
                    ReferredBy = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                    DateCreated = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    DateUpdated = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressLine1 = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    ...
                    CountryId = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    Zip = table.Column<string>(type: "text", nullable: true),
                    ContactNumber = table.Column<string>(type: "text", nullable: true),
                    Email = table.Column<string>(type: "text", nullable: true),
                    RetailerContactDetailId = table.Column<string>(type: "text", nullable: true),
                    DateCreated = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    DateUpdated = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContactDetails_ContactDetails_RetailerContactDetailId",
                        column: x => x.RetailerContactDetailId,
                        principalTable: "ContactDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ContactDetails_Countries_CountryId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    RetailerId = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnableBackOrder = table.Column<bool>(type: "boolean", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    DateUpdated = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true)
            ...
            migrationBuilder.CreateTable(
                name: "RetailerContactDetails",
                columns: table => new
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    RetailerId = table.Column<string>(type: "text", nullable: false),
                    ContactDetailerId = table.Column<string>(type: "text", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    DateUpdated = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RetailerContactDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RetailerContactDetails_ContactDetails_ContactDetailerId",
                        column: x => x.ContactDetailerId,
                        principalTable: "ContactDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RetailerContactDetails_Retailers_RetailerId",
                        column: x => x.RetailerId,
                        principalTable: "Retailers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactDetails_RetailerContactDetailId",
                table: "ContactDetails",
                column: "RetailerContactDetailId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RetailerContactDetails_ContactDetailerId",
                table: "RetailerContactDetails",
                column: "ContactDetailerId");

            migrationBuilder.CreateIndex(
                name: "IX_RetailerContactDetails_RetailerId",
                table: "RetailerContactDetails",
                column: "RetailerId");
